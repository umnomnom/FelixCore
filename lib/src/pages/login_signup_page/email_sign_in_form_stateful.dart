...
import 'package:felix_core/src/pages/login_signup_page/email_sign_in_model.dart';
import 'package:felix_core/src/pages/login_signup_page/validators.dart';
...
class _EmailSignInFormStatefulState extends State<EmailSignInFormStateful> {
  ...
  void _emailEditingComplete() {
    final newFocus = widget.nameValidator.isValid(_email)
        ? _passwordFocusNode
        : _emailFocusNode;
  ...
  List<Widget> _buildChildren() {
    ...
    bool submitEnabled = widget.nameValidator.isValid(_email) &&
  ...
  TextField _buildEmailTextField() {
    bool showErrorText = _submitted && !widget.nameValidator.isValid(_email);
    return TextField(
      key: Key('email'),
